/**
 * Package-owned request-reconstruction invariant for pi-loop-built LLM calls,
 * shared with the stock loop: the pi bridge marks its requests
 * (`markAgentLoopRequest`), so the same "model-visible ⟺ logged" check applies
 * to pi-driven calls.
 * @module @deepseek-ai/dsh-pi-agent-loop/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-pi-agent-loop'

/** Cordis companion plugin name. */
export const name = 'pi-agent-loop-invariant'
...
/**
 * Register the pi-agent-loop invariant companion.
